...
from sb3_contrib.bdqn.policies import MlpPolicy
...
class BDQN(OffPolicyAlgorithm):
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(BDQN, self)._excluded_save_params() + ["q_net", "q_net_target"]
