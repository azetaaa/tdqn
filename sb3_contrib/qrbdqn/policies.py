...
class QuantileNetwork(BasePolicy):
    ...
    def __init__(
        ...
        quantile_net = create_mlp(self.features_dim, 0, self.net_arch, self.activation_fn)
...
class QRBDQNPolicy(BasePolicy):
    """
    Policy class with quantile and target networks for QR-BDQN.
    ...
    def __init__(
        ...
        super(QRBDQNPolicy, self).__init__(
            observation_space,
            action_space,
