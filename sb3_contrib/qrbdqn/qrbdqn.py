...
from sb3_contrib.common.off_policy_algorithm import OffPolicyAlgorithm
from stable_baselines3.common.preprocessing import maybe_transpose
from stable_baselines3.common.type_aliases import GymEnv, MaybeCallback, Schedule
from stable_baselines3.common.utils import get_linear_fn, is_vectorized_observation, polyak_update

from sb3_contrib.common.utils import quantile_huber_loss, reshape_quantiles
from sb3_contrib.qrbdqn.policies import MlpPolicy


class QRBDQN(OffPolicyAlgorithm):
    """
    Quantile Regression Branching Deep Q-Network (QR-BDQN)

    Built upon Stable Baselines 3 Quantile Regression Deep Q-Network (QR-DQN)
    ...
    def _setup_model(self) -> None:
        super(QRBDQN, self)._setup_model()
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for _ in range(gradient_steps):
            ...
            # Make "n_quantiles" copies of actions, and reshape to (batch_size, n_quantiles, 1)
            actions = reshape_quantiles(replay_data.actions, batch_size, self.n_quantiles, self.device)
    ...
    def learn(
        ...
        tb_log_name: str = "QRBDQN",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(QRBDQN, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(QRBDQN, self)._excluded_save_params() + ["quantile_net", "quantile_net_target"]
