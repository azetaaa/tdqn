...
from sb3_contrib.tdqn.policies import MlpPolicy


class TDQN(OffPolicyAlgorithm):
    """
    Trading Deep Q-Network (TDQN)
    aka Quantile Regression Branching Deep Q-Network with Noisy Linear Layers
    ...
    def predict(
        ...
        if isinstance(action, float):
            ...
            action = [action for _ in range(action_dim)]
    ...
    def learn(
        ...
        tb_log_name: str = "TDQN",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(TDQN, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(TDQN, self)._excluded_save_params() + ["quantile_net", "quantile_net_target"]
